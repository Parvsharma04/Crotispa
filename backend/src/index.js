...
const templatePath = path.join(__dirname, "../NewFolder/templates");
const publicPath = path.join(__dirname, "../NewFolder/public");
const homePath = path.join(__dirname, "../PRO/home.html");
